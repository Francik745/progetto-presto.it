<x-slot name="title">Pagina Profilo</x-slot>

<div class="container d-flex">
    <div class="row my-5">
        <div class="col-12">
            <h2 class="text-center my-4 f-sec fw-bold display-6">Inserisci i dati del tuo profilo</h2>
                       
            <form wire:submit.prevent="CreateProfile" class="f-main">
                @csrf
                <div class="mt-4 mb-3">
                ...
                {{-- <div class="form-check-inline m-3">
                    ...
                    <input class="form-check-input mb-2" type="radio" id="gender-male" name="gender" value="Uomo" wire:model="gender">
                    <label for="gender-male">Uomo</label><br>
                    <input class="form-check-input mb-2" type="radio" id="gender-female" name="gender" value="Donna" wire:model="gender">
                    <label for="gender-female">Donna</label><br>
                    <input class="form-check-input mb-2" type="radio" id="gender-other" name="gender" value="Altro" wire:model="gender">
                    <label for="gender-other">Altro</label>
                    @error('gender')
                    <span class="error text-danger">{{ $message }}</span>
                    @enderror
                ...
                <button type="submit" class="btn bg-acc mt-3">Completa profilo</button>
            </form>
        </div>
